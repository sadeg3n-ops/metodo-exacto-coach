...
6. comprobar producción en https://metodo-exacto-coach.vercel.app

## Notas específicas para futuro Codex
- La landing se compone en `app/page.tsx` y el CTA intenta abrir Calendly antes de caer al modal local.
- Mantener coherentes `app/layout.tsx`, las previews sociales y `.env.example`.
