...
- Si se quiere captación robusta con backend, faltan validación server-side, anti-spam y almacenamiento seguro.
- Sustituir teléfonos placeholder antes de tráfico real.
- Añadir aviso legal, privacidad y cookies si se abre tráfico comercial real.
